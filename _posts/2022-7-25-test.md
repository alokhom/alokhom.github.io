...
--------------------
- Make new gcs bucket using https://github.com/thelastpickle/cassandra-medusa/tree/master/docs in the same google project and operationalise the medusa on the k8ssandra using the following documentation. https://docs-v2.k8ssandra.io/tasks/backup-restore/. 
- Create and apply secret using the credentials.json renames as medusa_gcp_key.json
```
kubectl create secret generic google-storage-s3-json -n <namespace-of-k8ssandra-cassandra> --from-file=medusa_gcp_key.json=/tmp/medusa_gcp_key.json
```
...
```
  cassandra_backup.yaml: |
    ...
    metadata:
      name: medusa-daily-timestamp
      namespace: <namespace-of-k8ssandra-cassandra>
    spec:
      backupType: "differential"
      name: medusa-daily-timestamp
      cassandraDatacenter: dc1
...
Next steps
----------
- Ensure the namespace in all the scripts above is <namespace of the sts file>
