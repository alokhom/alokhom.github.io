...
Next steps
----------
- Change the clients to point to a new pod selector
- Change selector `app: cassandra` to `cassandra.datastax.com/datacenter: k8s-1` in the same namespace  where the sts was working. 
```
apiVersion: v1
kind: Service
metadata:
